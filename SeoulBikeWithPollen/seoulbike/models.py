...
class SeoulBikeStationNow(models.Model):
    station = models.ForeignKey(SeoulBikeStationInfo, related_name='now', on_delete=models.CASCADE, default=0)
    # 자전거 거치 수
    bikecnt = models.IntegerField(verbose_name="자전거 수", default=0)
    # 자전거 거치율
